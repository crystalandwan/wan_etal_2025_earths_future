# *****************************************************************************************
# Title: Heat Wave Spatial Coverage Calculation 1
# Author: Heng Wan
# Date: 10/20/2025
...
#              heat wave events under definition 1, 2, 3, 4, 5, and 9. The spatial coverage of 
...
#' @param threshold Numeric. Heat wave temperature threshold.
...
check_for_event <- function(county_temps, threshold) {
  ...
  # Extract lengths where temperatures are above threshold
  high_temp_periods <- wave_lengths$lengths[wave_lengths$values]
  
  # Check if any period of high temps is at least 2 days long
  any(high_temp_periods >= 2)
}
